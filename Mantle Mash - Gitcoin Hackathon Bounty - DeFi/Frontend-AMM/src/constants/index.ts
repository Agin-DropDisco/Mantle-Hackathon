...
import { ChainId, JSBI, Percent, WETH, DEZU, WBNB, WBTC, USDC, USDT, Token, Currency } from '@zonudex/dexswap-sdk'
...
export const ZONU = new Token(
  ChainId.MANTLE_TESTNET,
  '0x565F39F6B8367a67317349c97dd78B8e4224db5C',
  18,
  'ZONU',
  'ZoNulet'
)
...
export const NETWORK_DETAIL: { [chainId: number]: NetworkDetails } = {
  ...
  [ChainId.MANTLE_TESTNET]: {
    ...
    chainName: 'MANTLE',
    nativeCurrency: {
      name: Currency.ETHER.name || 'BIT',
      symbol: Currency.ETHER.symbol || 'BIT',
      decimals: Currency.ETHER.decimals || 18
    },
  ...
  [ChainId.MUMBAI]: {
    ...
    chainName: 'MUMBAI',
    nativeCurrency: {
      name: Currency.ETHER.name || 'MATIC',
      symbol: Currency.ETHER.symbol || 'MATIC',
      decimals: Currency.ETHER.decimals || 18
    },
