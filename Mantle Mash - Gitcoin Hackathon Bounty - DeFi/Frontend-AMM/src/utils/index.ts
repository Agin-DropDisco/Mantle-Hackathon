...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, RoutablePlatform } from '@zonudex/dexswap-sdk'
...
export function getExplorerLink(
  ...
  if (chainId === ChainId.MANTLE_TESTNET && type === 'token') {
...
export function getRouterContract(
  ...
  return getContract(
    platform.routerAddress[chainId ? chainId : ChainId.MANTLE_TESTNET] as string,
    IDexSwapRouterABI,
    library,
    account
  )
