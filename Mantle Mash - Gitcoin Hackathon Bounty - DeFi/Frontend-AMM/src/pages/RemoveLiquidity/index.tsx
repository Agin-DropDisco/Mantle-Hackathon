...
import { Currency, currencyEquals, Percent, CurrencyAmount, JSBI, ChainId, RoutablePlatform } from '@zonudex/dexswap-sdk'
...
export default function RemoveLiquidity({
  ...
  const routerAddress = RoutablePlatform.DEXSWAP.routerAddress[chainId ? chainId : ChainId.MANTLE_TESTNET]
