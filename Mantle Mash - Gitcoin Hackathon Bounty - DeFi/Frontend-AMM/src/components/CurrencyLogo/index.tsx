import { ChainId, Currency, Token, DEZU } from '@zonudex/dexswap-sdk'
...
export default function CurrencyLogo({
  ...
  const nativeCurrencyLogo = NATIVE_CURRENCY_LOGO[(chainId as ChainId) || ChainId.MANTLE_TESTNET]
