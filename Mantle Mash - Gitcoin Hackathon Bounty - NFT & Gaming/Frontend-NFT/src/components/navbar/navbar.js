...
class NavbarMain extends Component {
  ...
  async loadMetaMask() {
    ...
    if (this.state.account) {
      ...
      const mantlebalance = web3one.utils.fromWei(
        await web3one.eth.getBalance(this.state.account),
        'ether',
      )
                  ...
                  <>
                    <Nav className="me-auto">
                      ...
                      <NavDropdown
                        title={
                          <span
                            className="categorynav dropdown-menu-center"
                ...
                <NavDropdown.Divider /> */}
                    ...
                    <div className="socialBtn">
                      <Nav className="me-auto">
                        ...
                        <Nav.Link href="#" className="socialBtna" target="_blank" rel="noreferrer">
                          <svg
                            className="zooSvgIcon zooSvgIcon_big"
                            focusable="false"
                            aria-hidden="true"
                            viewBox="0 0 24 24"
                            width="24"
                            ...
                            fill="none"
                          >
                            <path d="M14.82 4.26001C14.6214 4.6157 14.4444 4.98303 14.29 5.36001C12.7728 5.12006 11.2273 5.12006 9.71004 5.36001C9.55563 4.98303 9.37864 4.6157 9.18004 4.26001C7.75083 4.50421 6.36144 4.94155 5.05004 5.56001C2.70498 8.9443 1.64148 13.053 2.05004 17.15C3.57828 18.2989 5.2935 19.1751 7.12004 19.74C7.53595 19.1906 7.90714 18.6087 8.23004 18C7.63411 17.7803 7.06134 17.5023 6.52004 17.17C6.6685 17.0712 6.80894 16.9609 6.94004 16.84C8.5185 17.6003 10.248 17.9952 12 17.9952C13.7521 17.9952 15.4816 17.6003 17.06 16.84C17.2 16.96 17.34 17.07 17.48 17.17C16.9358 17.4997 16.3636 17.7807 15.77 18.01C16.0795 18.6325 16.4408 19.228 16.85 19.79C18.6743 19.227 20.3866 18.3506 21.91 17.2C22.3284 13.1022 21.264 8.99019 18.91 5.61001C17.6134 4.97875 16.2377 4.52468 14.82 4.26001ZM8.68004 14.81C8.17962 14.7741 7.71258 14.5457 7.37696 14.1728C7.04134 13.7999 6.86323 13.3114 6.88004 12.81C6.8607 12.3079 7.03793 11.8181 7.37405 11.4446C7.71018 11.0711 8.1787 10.8435 8.68004 10.81C9.18138 10.8435 9.6499 11.0711 9.98603 11.4446C10.3222 11.8181 10.4994 12.3079 10.48 12.81C10.4994 13.3121 10.3222 13.8019 9.98603 14.1754C9.6499 14.5489 9.18138 14.7765 8.68004 14.81ZM15.32 14.81C14.8196 14.7741 14.3526 14.5457 14.017 14.1728C13.6813 13.7999 13.5032 13.3114 13.52 12.81C13.5007 12.3079 13.6779 11.8181 14.014 11.4446C14.3502 11.0711 14.8187 10.8435 15.32 10.81C15.8223 10.841 16.2923 11.0679 16.629 11.442C16.9656 11.816 17.142 12.3073 17.12 12.81C17.142 13.3128 16.9656 13.804 16.629 14.1781C16.2923 14.5521 15.8223 14.779 15.32 14.81Z"></path>
                          </svg>
                        </Nav.Link>
                        <Nav.Link href="#" className="socialBtna" target="_blank" rel="noreferrer">
                          <svg
                            className="zooSvgIcon"
                            focusable="false"
                            aria-hidden="true"
                            viewBox="0 0 24 24"
                            width="24"
                    ...
                    <Nav>
                      ...
                      <NavDropdown
                        ...
                        flip="true"
                      >
                        <NavDropdown.Item href="#" align="center" className="bal">
                          {this.state.account.substring(0, 15) + '...'}
                        </NavDropdown.Item>
                        <NavDropdown.Divider />
                        <NavDropdown.Item
                          href="https://dex.zonulet.io/#/swap?inputCurrency=BIT&outputCurrency=0x9C3a2429A288dBEA75C819Fd18C0b35a0C3E1361"
                          target="_blank"
                          align="center"
                          className="bal"
                        >
                          {this.state.balance}{' '}
                          <span style={{ fontSize: '14px', fontWeight: 'bold', color: '#00ff72' }}>
                            ZONU
                          </span>
                        </NavDropdown.Item>
                        <NavDropdown.Divider />
                        <NavDropdown.Item
                          href="https://dex.zonulet.io/#/swap?inputCurrency=BIT&outputCurrency=0xCab6D79dD732779f081B5868AAb1e64F357e90A9"
                          target="_blank"
                          align="center"
                          className="bal"
                        >
                          {this.state.dezubalance}{' '}
                          <span style={{ fontSize: '14px', fontWeight: 'bold', color: '#00ff72' }}>
                            DEZU
                          </span>
                        </NavDropdown.Item>
                        ...
                        <NavDropdown.Divider />
                        <NavDropdown.Item href="/editprofile/" align="center" className="bal">
                          Edit Profile
                        </NavDropdown.Item>
                        <NavDropdown.Divider />
                        {this.state.verified !== true ? (
                        ...
                        <NavDropdown.Divider />
                        <NavDropdown.Item
                          href={'https://github.com/zonulet-io'}
                          target="_blank"
                          className="kal"
                        >
