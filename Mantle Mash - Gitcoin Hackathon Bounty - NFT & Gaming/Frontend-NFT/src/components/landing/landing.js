...
class Landing extends Component {
  ...
  buyZonuin = () => {
    ...
    const mantleabi = [
      {
        ...
        inputs: [
          ...
          { type: 'address', indexed: true, name: 'guy', internalType: 'address' },
          { internalType: 'uint256', type: 'uint256', indexed: false, name: 'wad' },
        ],
        anonymous: false,
        name: 'Approval',
      },
      {
        ...
        name: 'Deposit',
        inputs: [
          { internalType: 'address', name: 'dst', type: 'address', indexed: true },
          { indexed: false, internalType: 'uint256', type: 'uint256', name: 'wad' },
        ],
        type: 'event',
      },
      {
        ...
        anonymous: false,
        inputs: [
          { indexed: true, type: 'address', internalType: 'address', name: 'src' },
          { indexed: true, name: 'dst', internalType: 'address', type: 'address' },
          { indexed: false, name: 'wad', type: 'uint256', internalType: 'uint256' },
        ],
        name: 'Transfer',
      },
      {
        ...
        type: 'event',
        inputs: [
          { name: 'src', indexed: true, type: 'address', internalType: 'address' },
          { type: 'uint256', indexed: false, name: 'wad', internalType: 'uint256' },
        ],
        anonymous: false,
      },
      {
      ...
      { stateMutability: 'payable', name: 'deposit', type: 'function', inputs: [], outputs: [] },
      {
        name: 'withdraw',
        type: 'function',
        outputs: [],
      ...
      {
        inputs: [
          { type: 'address', internalType: 'address', name: 'guy' },
          { type: 'uint256', internalType: 'uint256', name: 'wad' },
        ],
        type: 'function',
        stateMutability: 'nonpayable',
        name: 'approve',
      ...
      },
      {
        ...
        inputs: [
          ...
          { internalType: 'uint256', type: 'uint256', name: 'wad' },
        ],
    ...
    const zonuletZDEXabi = [
      { inputs: [], stateMutability: 'nonpayable', type: 'constructor' },
      {
        inputs: [{ internalType: 'uint256', name: 'zonuAmount', type: 'uint256' }],
        name: 'getEstimatedMANTLEforZONU',
        outputs: [{ internalType: 'uint256[]', name: '', type: 'uint256[]' }],
        stateMutability: 'view',
        type: 'function',
      },
      {
        inputs: [{ internalType: 'uint256', name: 'mantleAmount', type: 'uint256' }],
        name: 'getEstimatedZONUforMANTLE',
        outputs: [{ internalType: 'uint256[]', name: '', type: 'uint256[]' }],
        stateMutability: 'view',
        type: 'function',
      },
      ...
      {
        inputs: [
          { internalType: 'uint256', name: 'zonuAmount', type: 'uint256' },
    ...
    const contractzonulet = new web3.eth.Contract(
      zonuletZDEXabi,
    ...
    contractzonulet.methods
      .getEstimatedMANTLEforZONU(slippage.toString())
      .call()
      .then(receipt => {
        ...
        contractone.methods
          ...
          .once('receipt', receipt => {
            ...
            contractzonulet.methods
              .zonulet(slippage.toString(), deadline)
  ...
  changeAmount = amount => {
    if (amount > 0) {
      ...
      const contractzonulet2 = new web3.eth.Contract(
        zonuletZDEXabi2,
        '0x527c79B07993067390780514cBC6c41E041E3e3e',
      )

      this.setState({ mantleamount: amount })
      ...
      contractzonulet2.methods
        .getEstimatedMANTLEforZONU(web3.utils.toWei(amount.toString(), 'ether'))
        .call()
        .then(receipt => {
  ...
  async like(e, owner, key) {
    ...
    const contractlike = new web3t.eth.Contract(
      abilike,
      '0x93A54F1f67428bfF04394551BfeC98D28bcb0d8b',
    )
    ...
    contractlike.methods
      ...
      .once('receipt', receipt => {
        ...
        document.getElementById('count' + key).innerHTML =
          Number(document.getElementById('count' + key).innerHTML) + 1
  ...
  async ice(e, owner, key) {
    ...
    token_contract.methods
      .approve(
        '0x93A54F1f67428bfF04394551BfeC98D28bcb0d8b',
        web3one.utils.toWei(pacmanprice, 'ether'),
      )
      .send({ from: acct })
      .once('receipt', receipt => {
        contractlike.methods
  ...
  async loadMantleData() {
    ...
    setInterval(async () => {
      if (typeof web3 !== 'undefined' && this.state.showZONUModal === true) {
        const mantlebalance = web3.utils.fromWei(
          await web3.eth.getBalance(this.state.account),
          'ether',
        )
        if (mantlebalance > 0 && typeof mantlebalance !== 'undefined') {
          ...
          if (zonubal > 0 && zonubal !== null) {
            ...
            document.getElementById('zonubal').innerHTML = this.abbreviateNumber(
              Number(zonubalance),
            )
          }
        }
      ...
      const contractone = new web3t.eth.Contract(
        mantleabi,
        '0x707f2fE56A440E766bec41aBC9fc8695567D0ceA',
      )

      const balBITlp = await contractone.methods
        .balanceOf('0xfcf2523Bd03074F870d7a874EB716a370558d774')
        .call() // DexSwap (BIT - ZONU)
      const balDEZUBITlp = await contractone.methods
        .balanceOf('0x6e715ED441c28cF7e43A7Dfa0353546697bCE385')
        .call() //DexSwap (BIT - USDC)
      const balUSDC = await contractone.methods
        .balanceOf('0xDdC4da8F3c490Ce1a1b7bB5212c47391B372B43c')
        .call() // DexSwap (WBNB - USDC)
      const balZonu = await contractone.methods
        .balanceOf('0xd8874ff41F0A59d9Af08f0a8041534084d405006')
        .call() // DexSwap (DEZU - ZONU)
      ...
      const zonubal = await contract.methods
    ...
    const abiblack = [
      { inputs: [], stateMutability: 'nonpayable', type: 'constructor' },
      {
        anonymous: false,
        inputs: [
          { indexed: true, internalType: 'address', name: 'hashAddress', type: 'address' },
      ...
      {
        inputs: [{ internalType: 'address', name: 'blAddress', type: 'address' }],
    ...
    const contractblack = new web3t.eth.Contract(
      abiblack,
      '0x0739948117Ee512eF799132c611c28B201B87c1b',
    )
      ...
      <div>
        ...
        >
          ...
          >
            <div align="center">
              <p>
                Welcome to the <strong>Zonulet NFT Marketplace</strong>! This market is open and
                decentralized on the Mantle Network. Anyone can mint NFTs and list them for sale.
                This results in possible fakes and scammers. We utilize different smart contracts to
                "Verify" or "Blacklist" users manually. Please use due diligence when making
                purchases of NFTs! When you buy a NFT here you are directly sending that user ZONU,
                there is no method of refunds. If it is too good to be true, it probably is!
              </p>
          ...
          >
            ...
            <h2 align="center">
              <img src="/mantle.svg" border="0" height="66px" width="66px" />{' '}
                ...
                <div className="featuredContainer my-auto align-middle">
                  <div className="col-md-6 blockReact1">
                    <h1 className="g-0 g-md-1 textReact">
                      YOUR FAVORITE NFT MARKETPLACE <br />
                      YOU HAVE NOT SEEN YET
                    </h1>
                    <span className="subheader trsLight">
                      Zonulet is a Decentralized Marketplace that uses most of the{' '}
                      <strong>
                        <span className="txtGreen">IPFS</span>&nbsp; and
                      </strong>{' '}
                      <strong>
                        <span className="txtBlue"> Mantle Blockchain </span>
                      </strong>{' '}
                      technology to store all NFT files and Transactions
                    </span>
                          ...
                          <div className="col-md-2 card cardW100 bg-light m-3 p-2">
                            <form onSubmit={event => {}}>
                              <div className="col-auto max-450">
                                <div
                                  className="text-secondary idbadge idbadgeOrange"
                                  align="center"
                                >
                        ...
                        <div className="col-md-2 card cardW100 bg-light m-3 p-2 myes">
                          ...
                          >
                            <form onSubmit={event => {}}>
                              <div className="col-auto max-450">
                                <div
                                  className="text-secondary idbadge idbadgeYellow"
                                  align="center"
                                >
                ...
                <div className="row" align="center">
                  <div className="grande_partita">
                    <div className="funded_by">
                      <span className="glitch fs17" data-text="STATISTICS">
                        STATISTICS
                      </span>
                    </div>
                  </div>
