              ...
              <div className="form-container">
                ...
                <div className="col-md-12">
                  <p className="text-secondary profile_editor_text" id="prof_editor">
                    This is where you can upload a new avatar for your Mantle address profile on the
                    Mantle Blockchain through this form. All avatar data is stored on IPFS and the
                    Mantle Blockchain with our Zonulet Avatar Contract. This will create one
                    transaction, costs minimal gas, with no extra fee to update your avatar.
                  </p>
                </div>
                <div
                  align="center"
                  id="wrapperdiv2"
                  className="banner_editor"
                  style={{
                    display: 'none',
                    height: '0px',
                    paddingBottom: '18%',
                ...
                >
                  ...
                  <div className="col-md-4">
                    ...
                    <input
                      ...
                      className="form-control my-2"
                      placeholder={
                        this.state.website === '' ? 'https://mywebsite.com' : this.state.website
                      }
                      rows="3"
                    ...
                    <progress
                      id="progressBar"
                      className="once_process"
                      value="0"
                      max="100"
                    ></progress>
                    <div id="progressBar2"></div>
                    <span className="once_sending" id="on_sending">
                      WAITING FOR CONFIRMATION...
                    </span>
                    <span className="once_txhash" id="on_hash">
                      PROCESSING DATA PLEASE WAIT...
                    </span>
                    <span className="once_receipt" id="on_receipt">
                      YOUR DATA HAS BEEN UPDATED,PLEASE REFRESH 🔄
                    </span>
  ...
  mintImage = () => {
    ...
    this.getBase64(this.state.new_image, async result => {
      ...
      if (file == null || file == '' || typeof file == 'undefined') {
        ...
        this.state.new_twitter == '' ||
        this.state.new_website == '' ||
        this.state.new_instagram == ''
      ) {
        ...
        function progressCall(data) {
          ...
          fileccoinProgress.innerHTML =
            '<strong>PREPARE FOR UPLOADING YOUR DATA TO <span class="txtBlue">MANTLE</span> & <span class="txtBlue2">IPFS</span><br />TOTAL SIZE: </strong> <strong class="txtGreen">' +
        ...
        fetch('https://ipfs.infura.io:5001/api/v0/pin/add?arg=' + hash, {
          ...
          .then(data => {
            ...
            if (hash != null && typeof hash != 'undefined') {
              this.state.contractava.methods
                .setAvatar(
                  hash,
                  mimetype,
                  this.state.new_name,
