...
function Mantle() {
  ...
  async function getNFTs() {
    ...
    if (networkData) {
      ...
      const contractlike = new web3.eth.Contract(
        abilike,
      ...
      <div className="container-fluid mb-5 explore-adj">
        <div className="row justify-content-around">
          <p align="center" className="text-secondary">
            This is where you can explore all "Mantle" category NFTs that were minted within Zonulet
            NFT Market.
          </p>
          <p>
              ...
              <div key={key.id} className="col-md-2 card bg-light m-3 p-2">
                <LazyLoad height={300}>
                        ...
                        {typeof key.ipfsData !== 'undefined' ? (
                          ...
                          key.mimeType === 'image/gif' ? (
                            <Img
                              ...
                              src={'https://zonulet.infura-ipfs.io/ipfs/' + key.ipfsData}
                              cache
                  ...
                  <div className="m-2 forsale_price" align="center">
                    <span>
                      {'Last Price : ' + key.price} &nbsp; ZONU &nbsp;
                      <img alt="main" className="zonu-class" src="../zonulet_stndr_1.svg" />
                    </span>{' '}
                  </div>
                </LazyLoad>
              </div>
