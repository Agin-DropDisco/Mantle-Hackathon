        ...
        <div>
          ...
          <MetaTags>
            ...
            <meta
              property="og:image"
              content={
                this.state.ipfs ? 'https://zonulet.infura-ipfs.io/ipfs/' + this.state.ipfs : null
              }
            />
          </MetaTags>
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <div className="account_address">
                  <span className="account_name">
                    <span className="nft_collection_of">
                      NFT COLLECTION BY
                      {this.state.name === '' ? (
                        ' ADDRESS'
                      ) : (
                        <strong className="txtPinkBlack">{' ' + this.state.name}</strong>
                      )}
                    </span>
                  </span>
                </div>
                <div className="account_bio">
                  <span className="text_bio">{this.state.bio}</span>
                </div>
                <div className="account_user_balance">
                  <span className="dezu_balance text-light">
                    ...
                    >
                      <span>
                        <strong className="count_balance">
                    ...
                    <br />
                    <span className="nameText_balance">DEZU Balance</span>
                  </span>
                  <span className="zonu_balance text-light">
                    ...
                    <br />
                    <span className="nameText_balance">ZONU Balance</span>
                  </span>
                  <span className="one_balance text-light">
                    ...
                    <br />
                    <span className="nameText_balance">MANTLE BALANCE</span>
                  </span>
                </div>
              </div>
              <div className="col-md-6 pdl-50">
                ...
                <div className="users_links">
                  <span className="address_img">
                    {' '}
                    <strong className="text-light">{this.state.account}</strong>
                    <a
                      href={
                        'https://explorer.testnet.mantle.xyz/address/0x2F400bb9bd8c5D29433F4DfDeEE6264031cda78f?a=' +
                        this.state.account
                      }
                      target="_blank"
                ...
                <div className="social_links">
                  <span className="social_markup">
                    <span className="mantle_link">
                      <a
                        href={'https://explorer.testnet.mantle.xyz/address/' + this.state.account}
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                ...
                <div className="count_total_activity">
                  <span className="text-light owner_nft">
                    ...
                    >
                      <span>
                        <strong className="count_nft">{this.state.ownercollection.length}</strong>
                      </span>
                    </ReactPlaceholder>
                    <br />
                  ...
                  <span className="text-light minted_nft">
                    ...
                    >
                      <span>
                        <strong className="count_nft">{this.state.mintedcollection.length}</strong>
                      </span>
                    </ReactPlaceholder>
                    <br />
              ...
              {this.state.blacklisted ? (
                ...
                <Tabs defaultActiveKey="1" id="uncontrolled-tab-example" className="mt-35">
                      ...
                      <div className="row justify-content-around">
                        ...
                        >
                          {this.state.images.map((id, key) => {
                            return this.state.owner === this.state.account &&
                                ...
                                >
                                  <div className="col-auto max-250">
                                    ...
                                    {typeof this.state.imageData_ipfsData[key] !== 'undefined' ? (
                                      ...
                                      ) : this.state.imageData_mimeType[key] ===
                                        'model/gltf-binary' ? (
                                        <model-viewer
                                          src={
                                            'https://zonulet.infura-ipfs.io/ipfs/' +
                  ...
                  <Tab eventKey="4" title="Activity" style={{ textAlign: 'center' }}>
                    <img
                      src="/chart-sample.svg"
                      style={{ width: '24%', padding: '0px 15px 0px 15px', opacity: '0.8' }}
                    />
                    <div style={{ color: '#ffffff8f', marginTop: '10px' }}>COMING SOON</div>
                  </Tab>
                </Tabs>
              )}
            </div>
  ...
  async loadMantleData() {
    ...
    if (networkData) {
      ...
      if (web3one.utils.isAddress(this.state.account)) {
        ...
        const reward = await contractZonulet.methods
          .getAccountDividendsInfo(this.state.account)
          .call()
        ...
        const contractblack = new web3one.eth.Contract(
          abiblack,
