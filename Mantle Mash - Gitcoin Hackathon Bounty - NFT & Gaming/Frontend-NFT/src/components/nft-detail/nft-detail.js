...
class Mint extends Component {
  ...
  async loadMantleData() {
    ...
    if (web3 !== undefined) {
      ...
      const est = await this.state.contractzonulet.methods
        .getEstimatedMANTLEforZONU(
          parseInt(web3.utils.toWei(slippage.toString()).toString() / 1e18),
        )
        .call()
      const estone = est[0]
      // console.log(est[0])
    ...
    var approved = await maincontract.methods
      .isApprovedOrOwner('0xA7eEe2528D0858988950664aFC71b4B0Cdaf074d', key)
      .call() //ZonuletNFTSale
    ...
    const icecount = await contractlike.methods.nftPacmans(key).call()
    this.setState({ likecount: likecount.likes })
    this.setState({ icecount: icecount.pacmans })
    ...
    return (
      <div>
        <MetaTags>
          ...
          <meta
            property="og:title"
            content={'ZONU NFT #' + key + ' - ' + this.state.imageData_name}
          />
          <meta
            property="og:description"
            content={'Zonulet NFT #' + key + ' - ' + this.state.imageData_des + ' '}
          />
          <meta
            property="og:image"
              ...
              <div className="row">
                    ...
                    >
                      ...
                      this.state.imageData_mimeType === 'image/gif' ? (
                        <Img
                          ...
                          src={
                            'https://zonulet.infura-ipfs.io/ipfs/' + this.state.imageData_ipfsData
                          }
                          cache
                ...
                <div className="col-md-6">
                  ...
                  >
                      ...
                      <div align="center" style={{ top: '20px', position: 'relative' }}>
                        ...
                        <div>
                          <i
                            ...
                            style={{ fontSize: '12px', color: '#20ebf0' }}
                          />
                        </div>
                      </div>
                    ) : null}
                    <br />
                    <div
                      className="d-flex justify-content-center align-items-center my-1 text-light"
                      id="approvedsale"
                    >
                      {this.state.owner === this.state.account && this.state.loaded === true ? (
                        <form
                        ...
                        >
                          <div className="d-flex">
                            ...
                            <input
                              ...
                              className="btn btn-block btn-primary rounded-0 mx-1 buybtn"
                              value={
                                !this.state.approved ? 'Approve & List for Sale' : 'Update & Relist'
                              }
                              disabled={!this.state.blacklisted ? false : true}
                            />
                          </div>
                              ...
                              >
                                ...
                                <span>
                                  {this.state.connected === true ? (
                                    <>
                                      = {this.state.imageData_price} &nbsp;
                                      <small className="smallGreen">BIT</small>
                                    </>
                                  ) : (
                                    <div>Connect Wallet</div>
                                  )}
                    ...
                    <div className="d-flex justify-content-center align-items-center my-1">
                      ...
                      this.state.loaded === true ? (
                        <div className="text-danger">
                          {'This NFT is not approved for sale by the owner'}
                        </div>
                      ) : null}
                    </div>
                    <br />
                            ...
                            (this.state.mim === 'image/jpeg' ||
                              ...
                              <a href={'/collection/' + this.state.owner}>
                                ...
                                >
                                  <Jazzicon
                                    diameter={75}
                                    seed={jsNumberForAddress(this.state.owner)}
                                  />
                                  {this.state.owner_verified === true ? (
                                    <div
                                      style={{
                            ...
                            (this.state.mimmint === 'image/jpeg' ||
                              ...
                              <a href={'/collection/' + this.state.minter}>
                                ...
                                >
                                  <Img
                                    cache
                                    src={
                                      'https://zonulet.infura-ipfs.io/ipfs/' + this.state.ipfsmint
                                    }
                                    alt=""
                                    border="0"
                                    height="75px"
                              ...
                              <a href={'/collection/' + this.state.minter}>
                                ...
                                >
                                  <Jazzicon
                                    diameter={75}
                                    seed={jsNumberForAddress(this.state.minter)}
                                  />
                                  {this.state.mint_verified === true ? (
                                    <div
                                      style={{
                    ...
                    <div className="table-responsive">
                      ...
                      >
                        ...
                        <div align="center" className="dataNft">
                          ...
                          <div className="dataShareable mr15">
                            <NavDropdown.Item
                              href="https://forms.gle/pQWUmHssUifE3jh56"
                              target="_blank"
                              className="dal"
                            >
