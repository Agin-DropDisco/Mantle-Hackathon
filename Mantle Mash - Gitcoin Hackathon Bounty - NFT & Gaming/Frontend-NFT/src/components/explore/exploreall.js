  ...
  async loadMantleData() {
    ...
    const abiblack = [
      { stateMutability: 'nonpayable', type: 'constructor', inputs: [] },
      {
        ...
        inputs: [
          { internalType: 'address', indexed: true, name: 'hashAddress', type: 'address' },
      ...
      {
        inputs: [
          { name: 'nftID', indexed: true, type: 'uint256', internalType: 'uint256' },
          { name: 'blacklisted', type: 'bool', indexed: false, internalType: 'bool' },
        ],
      ...
      },
      {
        ...
        stateMutability: 'view',
        name: 'updates',
        inputs: [{ type: 'uint256', internalType: 'uint256', name: '' }],
      },
      {
        outputs: [],
      ...
      },
      {
        ...
        inputs: [{ name: 'blAddress', internalType: 'address', type: 'address' }],
        type: 'function',
      },
      {
        type: 'function',
    ...
    for (var k = this.state.totalSupply; k--; ) {
      ...
      if (j < 10) {
        ...
        if (!blacklisted) {
          ...
          const icecount = await contractlike.methods.nftPacmans(k).call()
          // console.log(metadata)
          this.setState({
            ...
            mimageData_icecount: [...this.state.mimageData_icecount, icecount.pacmans],
    ...
    fetch('https://node.zonulet.io/mantle.json', {
      mode: 'cors',
    })
      .then(response => {
        ...
        if (typeof transaction !== 'undefined') {
          if (transaction.returnValues !== 'undefined') {
            const metadata = await contract.methods
              .imageData(transaction.returnValues._tokenId)
              .call()

            const getIPFS = await contractAvatars.methods
              .getIPFSHash(transaction.returnValues._buyer)
              .call()
            const getMIME = await contractAvatars.methods
              .getMIMEType(transaction.returnValues._buyer)
              .call()
            const getVerified = await contractVerifiy.methods
              .getVerified(transaction.returnValues._buyer)
              .call()
      ...
      while (n--) {
        ...
        if (typeof gtransaction !== 'undefined') {
          if (gtransaction.returnValues !== 'undefined') {
            const metadata = await contract.methods
              .imageData(gtransaction.returnValues._tokenId)
              .call()

            const getIPFS = await contractAvatars.methods
              .getIPFSHash(gtransaction.returnValues._receiver)
              .call()
            const getMIME = await contractAvatars.methods
              .getMIMEType(gtransaction.returnValues._receiver)
              .call()
            const getVerified = await contractVerifiy.methods
              .getVerified(gtransaction.returnValues._receiver)
              .call()
            ...
            this.setState({
              ...
              gtximageData_receiver: [
                ...this.state.gtximageData_receiver,
                gtransaction.returnValues._receiver,
              ],
            ...
            <div className="col-md-12" align="center">
              <div className="row">
                <div className="col-md-6 my-auto">
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="market_cap mt15">
                        <span className="trsLight ls_4 mobilefont14">
                          <strong className="nameNFTs">1.[DEFI] DEXSWAP</strong>
                        </span>
                        <div className="trsLight mobilefont12"></div>
                        <span className="trsLight ls_4 mobileNone">
                          <strong className="nameNFTs"></strong>
                        </span>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="total_nfts mt15">
                        <span className="trsLight ls_4 mobilefont14">
                          <strong className="nameNFTs">2.[NFT] ZONULET</strong>
                        </span>
                        <div className="trsLight mobilefont12"></div>
                        <span className="trsLight ls_4 mobileNone">
                          <strong className="nameNFTs"></strong>
                  ...
                  <div className="row">
                    <div
                      className="my-auto total_funded"
                      style={{ display: 'flex', justifyContent: 'center' }}
                    >
                      <span className="nameNFTs mobilefont14">
                        <a href="https://github.com/Agin-DropDisco/Mantle-Hackathon">
                            ...
                            <div className="col" align="center">
                              <div className="m-2 text-light btAddress">
                                ...
                                <span style={{ fontSize: '13px' }}>
                                  Owned By{' '}
                                  <strong style={{ color: '#d17e67', fontWeight: 'bold' }}>
                            ...
                            <div className="col" align="center">
                              {this.state.owned.length > 0 ? (
                                ...
                                (this.state.mim === 'image/jpeg' ||
                                  ...
                                  >
                                    <Img
                                      src={'https://zonulet.infura-ipfs.io/ipfs/' + this.state.ipfs}
                                      cache
                                      alt=""
                                      border="0"
                                      height="50px"
                                  ...
                                  >
                                    <Jazzicon
                                      diameter={45}
                                      seed={jsNumberForAddress(this.state.owned)}
                                    />
                                    {this.state.feature_verified === true ? (
                                      <div
                                        style={{
                          ...
                          {typeof this.state.iData_ipfsData !== 'undefined' ? (
                            ...
                            this.state.iData_mimeType === 'image/gif' ? (
                              <Img
                                ...
                                src={
                                  'https://zonulet.infura-ipfs.io/ipfs/' + this.state.iData_ipfsData
                                }
                                cache
                  ...
                  {this.state.mimages.reverse().map((id, key) => {
                    return key < 8 ? (
                      this.state.latest_collections === true ? (
                        <div
                          key={key}
                          className="col-md-2 card cardW200 bg-light m-3 p-2 myes mbBottom"
                        >
                          <Link
                            to={{
                            ...
                            <form onSubmit={event => {}}>
                              <div className="col-auto max-350">
                                ...
                                {typeof this.state.mimageData_ipfsData[key] !== 'undefined' ? (
                                  ...
                                  ) : this.state.mimageData_mimeType2[key] ===
                                    'model/gltf-binary' ? (
                                    <model-viewer
                                      src={
                                        'https://zonulet.infura-ipfs.io/ipfs/' +
                              ...
                              <div className="bs_bottom">
                                ...
                                <div className="m-2 collection_category" align="center">
                                  <strong>OWNER : </strong>&nbsp;&nbsp;
                                  <span>
                                    {this.state.mimageData_owner[key].substring(0, 15) + '...'}
                                  </span>
                                  {/* {this.state.owned.substring(0, 8) + '...'} */}
                                </div>
                              </div>
                            ...
                            <form onSubmit={event => {}}>
                              <div className="col-auto max-350">
                                ...
                                {typeof this.state.imageData_ipfsData[key] !== 'undefined' ? (
                                  ...
                                  ) : this.state.mimageData_mimeType[key] ===
                                    'model/gltf-binary' ? (
                                    <model-viewer
                                      src={
                                        'https://zonulet.infura-ipfs.io/ipfs/' +
              ...
              <div className="row">
                <div className="col-md-3" align="center" style={{ padding: '30px' }}>
                  ...
                  <p className="text-secondary jtlast">
                    Once you’ve set up your wallet with Metamask, connect it to Zonulet by clicking
                    the "Connect Wallet" button in the top right corner. Only Metamask is supported.
                  </p>
                </div>
                <div className="col-md-3" align="center" style={{ padding: '30px' }}>
                  <h3 className="text-light">
                    <p>
                      <i
                        className="fa fa-compress-arrows-alt fa-2x"
                        style={{ color: '#0dcaf0' }}
                      ></i>
                    </p>
                    Add your collection
                  ...
                  <p className="text-secondary jtlast">
                    Click "Mint a NFT" and set up your Zonulet NFT collection. You can also edit
                    your profile to get a biography, profile avatar, and name stored on chain.
                  </p>
                </div>
                <div className="col-md-3" align="center" style={{ padding: '30px' }}>
                  <h3 className="text-light">
                  ...
                  <p className="text-secondary jtlast">
                    Upload your work (image, video, audio, or 3D model), add a name, category, and
                    description, it is cheaper than ever before with Zonulet on the Mantle network.
                  </p>
                </div>
                <div className="col-md-3" align="center" style={{ padding: '30px' }}>
                  <h3 className="text-light">
                  ...
                  <p className="text-secondary jtlast">
                    Choose between auctions (coming soon) and fixed-price listings. By selling an
                    NFT you receive Zonulet (ZONU) which rewards you DexSwap Token (DEZU)
                  </p>
                </div>
              </div>
              <a
                type="button"
                href="/product/search"
                className="btn btn-primary rounded m-3 homeButton6"
              >
