              ...
              <div className="row" style={{ marginBottom: '15px' }}>
                ...
                <div className="col-md-4 mnope" align="center">
                  ...
                  >
                    ...
                    Mantle Explorer{' '}
                    <a
                      href="https://explorer.testnet.mantle.xyz/address/0x2F400bb9bd8c5D29433F4DfDeEE6264031cda78f?activeTab=7"
                      target="_blank"
                      rel="noopener"
                    >
                      <span style={{ color: '#20ebf0' }}>0x2F400bb9bd8c..</span>&nbsp;&nbsp;
                      <i className="fa fa-cogs"></i>
                    </a>
                  </p>
                </div>
