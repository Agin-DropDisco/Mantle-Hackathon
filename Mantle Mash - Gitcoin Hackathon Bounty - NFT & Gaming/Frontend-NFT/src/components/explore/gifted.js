        ...
        <div className="container-fluid mb-5 explore-adj">
          <div className="row justify-content-around">
            <p align="center" className="text-secondary">
              This is where you can view recently gifted Zonulet NFTs! This displays the last 15
              gifted Zonulet NFTs!
            </p>
            <ReactPlaceholder
              type="rect"
          ...
          if (typeof gtransaction !== 'undefined') {
            if (gtransaction.returnValues !== 'undefined') {
              if (j < 15) {
                ...
                const getIPFS = await AvatarsContracts.methods
                  .getIPFSHash(gtransaction.returnValues._receiver)
                  .call()
                const getMIME = await AvatarsContracts.methods
                  .getMIMEType(gtransaction.returnValues._receiver)
                  .call()
                const getVerified = await VerifiedContracts.methods
