...
class Purchased extends Component {
        ...
        <div className="container-fluid mb-5 explore-adj">
          <div className="row justify-content-around">
            <p align="center" className="text-secondary">
              This is where you can view recently purchased Zonulet NFTs! This displays the last 15
              sold Zonulet NFTs!
            </p>
            <ReactPlaceholder
              type="rect"
                        ...
                        >
                          ...
                          >
                            <form onSubmit={event => {}}>
                              ...
                              <div className="m-2" align="center">
                                <strong>SOLD</strong>
                                {this.state.imageData_boughtprice[key]} ZONU
                              </div>
                            </form>
                          </Link>
                        </ReactPlaceholder>
  ...
  async loadMantleData() {
    ...
    if (networkData) {
      ...
      const contractblack = new web3.eth.Contract(
        abiblack,
          ...
          if (typeof gtransaction !== 'undefined') {
            if (gtransaction.returnValues !== 'undefined') {
              if (j < 15) {
                ...
                const getIPFS = await contractav.methods
                  .getIPFSHash(gtransaction.returnValues._buyer)
                  .call()
                const getMIME = await contractav.methods
                  .getMIMEType(gtransaction.returnValues._buyer)
                  .call()
                const getVerified = await contractv.methods
                  .getVerified(gtransaction.returnValues._buyer)
                  .call()
                ...
                this.setState({
                  ...
                  imageData_buyer: [
                    ...this.state.imageData_buyer,
                    gtransaction.returnValues._buyer,
                  ],
