        ...
        <div className="container-fluid mb-5 explore-adj">
          <div className="row justify-content-around">
            <p align="center" className="text-secondary">
              This is where you can explore Zonulet NFTs for sale, you can purchase any Zonulet
              listed here with Zonulet/ZONU!
            </p>
            <div align="center">
                          ...
                          <form onSubmit={event => {}}>
                            ...
                            <div className="m-2 forsale_price" align="center">
                              <span>
                                ...
                                <small>ZONU</small>&nbsp;or ${this.state.imageData_ZonuperUsd[key]}{' '}
                                <small>USD</small>
                              </span>
                            </div>
                          </form>
    ...
    if (networkData) {
      ...
      for (var i = totalSupply; i--; ) {
        ...
        if (!blacklisted) {
          ...
          var approv = await contract.methods
            .isApprovedOrOwner('0xA7eEe2528D0858988950664aFC71b4B0Cdaf074d', i)
            .call() //ZonuletNFTSale
