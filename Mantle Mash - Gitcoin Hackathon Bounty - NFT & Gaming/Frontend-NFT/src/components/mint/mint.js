...
class Mint extends Component {
                    ...
                    <div className="row">
                      <div className="col-md-6 align-middle my-auto">
                        <p
                          ...
                          align="center"
                        >
                          Mint a new ZONU NFT! The Zonulet NFT Minting process only costs gas (a
                          fraction of BIT), you can set a price in ZONU to sell your NFT after
                          minting! All NFTs are uploaded to IPFS for decentralization! We support
                          the media formats of <strong>png, jpeg, gif, mp4, and glb</strong>! Your
                          IPFS hash and NFT metadata is stored on the Mantle Blockchain. To sell
                          your NFT and list it on the market, after minting you must go to your NFT
                          details under your collection and then do two transactions to approve and
                          list your NFT! JPEGs and PNGs are compressed and optimized for uploading.
                          Max File Size is 50MB.
                        </p>
                      </div>
                      <div className="col-md-6">
                        <h3
                          className="mb-4 smlFont"
                          style={{ color: 'white', marginTop: '0px', fontSize: '77px' }}
                          align="center"
                        >
                          <span>MINT YOUR</span>
                          &nbsp;&nbsp;&nbsp;
                          ...
                          <div className="row" align="center">
                            ...
                            <div className="col-md-12" align="center">
                              <span style={{ marginLeft: '5px' }}>
                                By minting this NFT, You agree it is your own Intellectual property
                                & agree that the content is not illegal or unlawful in any
                                jursidiction.
                              </span>
                            </div>
                          </div>
  ...
  async loadMantleData() {
    ...
    const contractblack = new web3f.eth.Contract(
      abiblack,
      '0x0739948117Ee512eF799132c611c28B201B87c1b',
    )

    if (this.state.account) {
      const blacklisted = await contractblack.methods
        .getBlackListedAddress(this.state.account)
        .call()
  ...
  mintImage = () => {
    ...
    const INFURA_ID = '2FX3KsHR3Td4AyqPp58KKNRS94R'
    const INFURA_SECRET_KEY = '1dfadab013b2648ee5cf56dce065ad1a'
    ...
    var ipfs = create({
      ...
      apiPath: '/api/v0',
      headers: {
        Authorization: `Basic ${Buffer.from(INFURA_ID + ':' + INFURA_SECRET_KEY).toString(
          'base64',
        )}`,
      },
    })
